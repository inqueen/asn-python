...
print("Olá,", name, "Seja bem-vinda(o)!")
# %%
# EXERCICIO 2
name = input("Digite seu nome:")
age = input("Digite a sua idade:")
# print("Seu nome é", name, "e você tem", age, "anos")
print("Olá,", name, "Bom saber que você tem", age, "anos. Seja bem vinda(o)!")
# %%
# EXERCICIO ??
...
print("A área do raio", raio, "é igual a", area, "e o perímetro é igual a", perimetro)
...
print("O resultado de", valor1, "elevado a", valor2, "é ->", potencia)
# %%
# EXERCICIO 6
